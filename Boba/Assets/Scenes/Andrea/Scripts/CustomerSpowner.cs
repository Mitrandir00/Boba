...
public class CustomerSpawner : MonoBehaviour
{
    ...
    // Se disabilitiamo solo la logica ma lasciamo l'oggetto attivo
    private bool logicEnabled = true;


    // API
   
    //Abilita/Disabilita la logica di spawn (non distrugge il cliente in scena)
    ...
    //Ferma la routine attuale (storia o infinito). Non distrugge il cliente già presente.
